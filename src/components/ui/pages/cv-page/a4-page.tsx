...
export async function A4Page() {
  ...
  return (
    <div className="">
      <div className="grid grid-cols-1 md:mx-auto md:grid-cols-4  md:min-h-[1122px] md:max-h-[1122px]  md:min-w-[795px] md:max-w-[795px] bg-white shadow-lg shadow-zinc-400">
